const Footer = () => {
  ...
  return (
    <footer className="border-t border-gray-100 bg-white">
      <div className="mx-auto max-w-[1180px] px-5 py-10 sm:px-6 sm:py-12 lg:px-0">
        ...
        <div className="mt-10 flex flex-col gap-4 border-t border-gray-100 pt-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center justify-center gap-5 sm:justify-end">
            <a
              href="#privacy"
              className="text-[11px] text-slate-400 transition-colors duration-200 hover:text-gray-900"
            >
              Privacy
            </a>
